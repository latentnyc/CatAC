...
If working on production code, import `colors_and_type.css`, reuse `style.css` class names where they apply, and match the existing compact density (4px spacing rhythm, 108–120px cat cards, uppercase tracked H2 labels).
